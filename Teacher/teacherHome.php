...
if($username == 't.archibald'){
    echo '<a href="Incident/View_Incident_teacher.php">
...
?>
      ...
      <a href="Content/newResourcePack.php"><div class="w3-quarter w3-purple w3-margin-left w3-margin-bottom w3-round">
        <h2><i class="fa fa-graduation-cap"></i></h2>
