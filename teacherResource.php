...
<a href="teacherSearchResourcePacks.php"><-back</a>
...
if (!empty($tagString)) {
    ...
    if($createdBy === $username){
        echo "<a class='w3-button w3-black w3-round w3-margin-bottom w3-hover-opacity' href='teacherEditResourceTags.php?id=" . $thisId . "'>" . "Edit Tags" . "</a>";
    }
}
...
<div class="w3-row-padding">
    ...
    <div class='w3-container w3-white w3-round'>
     <h3>Course Information</h3>
      ...
      <?php
        if($createdBy === $username){
            echo "<a class='w3-button w3-black w3-round w3-margin-bottom w3-hover-opacity' href='teacherEditResourceDescription.php?id=" . $thisId . "'>" . "Edit Description" . "</a>";
        }
      ?>
      <h4>Subject</h4>
