<?php include_once "NewMenuAdmin.php" ?>
  ...
  <div id="Main" class="w3-panel w3-dark-grey w3-animate-right">
    ...
    <a href="teacherAccountCreate.php"><div class="w3-quarter w3-yellow w3-margin-left w3-margin-bottom w3-round">
      ...
      <a href="view_all_timesheets.php"><div class="w3-quarter w3-light-green w3-margin-left w3-margin-bottom w3-round">
        <h2><i class="fa fa-calendar"></i></h2>
        <p>View Timesheets</p>
      </div>
      </a>

      <a href="https://positive-progress.co.uk/webmail/log-in"><div class="w3-quarter w3-green w3-margin-left w3-margin-bottom w3-round same-size">
  ...
  <a href="adminViewSchools.php"><div class="w3-quarter w3-purple w3-margin-left w3-margin-bottom w3-round">
        <h2><i class="fa fa-search"></i></h2>
        <p>View Schools</p>
      </div>
  </a>

  <a href="adminViewSchoolStudent.php"><div class="w3-quarter w3-light-green w3-margin-left w3-margin-bottom w3-round">
        <h2><i class="fa fa-search"></i></h2>
