...
<a href="adminSearchResourcePacks.php"><-back</a>
...
echo "<a class='w3-button w3-black w3-round w3-margin-bottom w3-hover-opacity' href='adminEditResourceTags.php?id=" . $thisId . "'>" . "Edit Tags" . "</a>";
...
<div class="w3-row-padding">
    ...
    <div class='w3-container w3-white w3-round'>
     <h3>Course Information</h3>
      ...
      <p><?php echo $desc; ?></p>
      <?php
        echo "<a class='w3-button w3-black w3-round w3-margin-bottom w3-hover-opacity' href='adminEditResourceDescription.php?id=" . $thisId . "'>" . "Edit Description" . "</a>";
      ?>
      <h4>Subject</h4>
...
<form action="adminDeleteResourcePack.php" method="post" enctype="multipart/form-data">
<input type='hidden' value ='<?php echo $thisId ?>' name='fileID'>
<button class="w3-button w3-red w3-margin-bottom w3-padding-16 w3-border" type="submit">DELETE RESOURCE</button>
    </form>
</div>
