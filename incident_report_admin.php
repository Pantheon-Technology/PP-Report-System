...
$sql = "INSERT INTO `incidents` (`studentName`, `date`, `time`, `issueType`, `desc`, `reffered`, `otherReffered`, `followUp`, `whoFollowedUp`, `reportedBy`, `fullName`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        if ($stmt = mysqli_prepare($conn, $sql)) {
         mysqli_stmt_bind_param($stmt, "sssssssssss", $param_studentName, $param_date, $param_time, $param_issueType, $param_desc, $param_reffered, $param_otherReffered, $param_followUp, $param_whoFollowedUp, $param_reportedBy, $param_fullName);
...
?>
<p><b>Student Full Name</b></p>
<p><input class="w3-input w3-border w3-padding-16" type="text" name="fullName" placeholder="Name"></p>
